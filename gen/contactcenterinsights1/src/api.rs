...
/// ```
#[derive(Clone)]
pub struct Contactcenterinsights<S> {
...
impl<'a, S> client::Hub for Contactcenterinsights<S> {}

impl<'a, S> Contactcenterinsights<S> {

    pub fn new<A: 'static + client::GetToken>(client: hyper::Client<S, hyper::body::Body>, auth: A) -> Contactcenterinsights<S> {
